...
export default function MovieSearch() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-2 bg-white">
      <div className="w-full max-w-lg p-6  bg-gray-200 rounded-lg shadow-2xl">
        {/* Title of the Movie Search component */}
        <h1 className="text-4xl font-extrabold font-serif mb-1 text-center">Movie Search</h1>
        ...
        <div className="flex items-center mb-6">
          ...
          <Input
            type="text"
            placeholder="Enter a movie title (correctly)"
            value={searchTerm}
            onChange={handleChange}
            className="flex-1 mr-2 px-1 py-2 border rounded-md text-center focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          {/* Search button */}
          <Button
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-full text-center">
              ...
              <div className="flex justify-center items-center text-gray-600 mb-2">
                ...
                <span className="mr-4 pt-1"><strong>{movieDetails.Year}</strong></span>
                <StarIcon className="w-4 h-4 mr-1 fill-yellow-400" />
                <span className="pt-1"><strong>{movieDetails.imdbRating}</strong></span>
              </div> 
              <div className="flex justify-center items-center text-gray-600 mb-2">
                <span className="mr-4">
